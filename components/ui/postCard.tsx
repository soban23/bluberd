...
export default function PostCard({
  ...
  <Card className="w-full max-w-xl mx-auto mb-4 shadow-sm border border-muted dark:border-gray-700 bg-white dark:bg-gray-900">
    <CardHeader className="flex flex-row items-center gap-4 pb-0">
      ...
      <Avatar className="hover:cursor-pointer" onClick={() => onProfileClick?.()}>
  ...
  >
    <img
      ...
      width={600}
      height={400}
      className="w-full h-[300px] object-cover" // Fixed height and object-fit
...
//column "u.id" must appear in the GROUP BY clause or be used in an aggregate function'..click not pfpf?